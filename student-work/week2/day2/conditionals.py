...
#Handle in standard queue - correct
...
#short policy code is accepted - correct
...
#Claim is overdue for review - correct
...
#Route to SIU
# double ** means to the power of - correct
...
#Approved via manager override - correct
